...
public class MainActivity extends AppCompatActivity {
    ...
    private void xuLyPhepCong() {
        ...
        String s=a+"+"+b+"="+(a+b);
        Toast.makeText(MainActivity.this, "Tong: "+s, Toast.LENGTH_LONG).show();
        dsCong.add(s);
    ...
    private void addControls() {
        ...
        //thay chu bang hinh
        //tab1.setIndicator("", getResources().getDrawable(R.drawable).hinh);
        ...
        adapterCong= new ArrayAdapter<String>(
                            MainActivity.this,
                            android.R.layout.simple_list_item_1, dsCong);
